 ...
 * puff of smoke. So there are two different images for the fireball: fire or
 * smoke.
 */
public class Fireball extends DragonGameShape {
     ...
     * loadImages
     * ----------
     * This is just a helper method for the constructors, to load all the images we
     * need
     ...
     * move
     * ----
     * When this is called, it updates the fireball's position based on it's current
     * velocity, etc.
     * It also will bounce it off a wall (change velocity) if it's about to hit a
     * wall.
    ...
    public void move() {
        if (!fired)
            return; // no point in moving if it hasn't been fired.
    ...
    public void fire() {
        ...
        // System.out.println("FIRE: loc.xv = " + String.format("%.2f", loc.xv) + ",
        // loc.yv = " + String.format("%.2f", loc.yv));
    }
