...
//postcondition: 2 Squares, 2 Circles, and 1 Picture are constructed and manipulated,
//	then reclaimed once main exits

	public static void main(String[] args) {

		Square firstSquare = new Square();
		Square secondSquare = new Square(10, 20, 0);
		firstSquare.setX(3);
		firstSquare.setY(4);
		...
		Circle secondCircle = new Circle(5, 5, 0);
		firstCircle.setX(1);
		firstCircle.setY(5);
