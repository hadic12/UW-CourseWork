	...
	public class PolyDemoPanel extends JPanel {		
		...
		public PolyDemoPanel() {
			...
			***************************************/
				...
				myShapes [0] =  new FractalFlakes( 70,70 ); //getImposterShape();
//				myShapes [1] =  new UFO( 50,50,100 ); //getUFOShape();
//				myShapes [2] =  new DeathStar( 60,60,150); //getDeathStarShape();
//				myShapes [3] =  new PokeBall( 70,70, 150, 130); //getPokeBallShape();
